...
// Function to get current time as a string in milliseconds
...
// Testing cryptographic functionalities
void TestCrypto() {
    std::cout << "=============>" << std::endl;
    std::cout << "Cryptography related" << std::endl;
    std::cout << "<=============" << std::endl;

    // Convert hex string to binary for the private key
    ...
    // AES encryption and decryption of a message
    std::string message_ori = "hello world";
    std::string iv = HexAsc2ByteString("12345678901234567890123456789012");  // Load IV for AES
...
// Testing registration by invitation code
...
// Testing retrieval of node list
...
// Function to retrieve a token and parse JSON response
